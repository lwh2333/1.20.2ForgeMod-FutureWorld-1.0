...
public class PowerfulLeg extends Item{
    public PowerfulLeg(Item.Properties p_41383_) {
        super(p_41383_);
    }
        ...
        cap.ifPresent((I)->{
            ...
            for (PowerfulItemInfo info : l_info) {
                ...
                if (info.getName().equals("powerful_leg")) {
                    p_41433_.displayClientMessage(Component.translatable("info.autoplay."+((DataBase)(ModItems.POWERFUL_LEG_DATA_BASE.get())).getShortName()+"_installed").withStyle(ChatFormatting.RED),false);
                    p_41432_.playSound(null,p_41433_.getX(),p_41433_.getY(),p_41433_.getZ(), SoundEvents.ANVIL_PLACE, SoundSource.PLAYERS,1.0F,1.0F);
                    return;
                }
            }
            l_info.add(new PowerfulItemInfo(0,0,getQuality(),"powerful_leg"));
    ...
    public static double getVelocityScaleForOneStageByQuality(int quality){
